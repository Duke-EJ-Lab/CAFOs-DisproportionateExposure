...
% save data
Pwater_Renter_4km_BW = plots_BW;
Pwater_Renter_4km_HW = plots_HW;
save('Pwater_Renter_4km_BW.mat',...
    'Pwater_Renter_4km_BW');
save('Pwater_Renter_4km_HW.mat',...
    'Pwater_Renter_4km_HW');
