...
Pwater_Renter_5km_BW = plots_BW;
Pwater_Renter_5km_HW = plots_HW;

save('Pwater_Renter_5km_BW.mat',...
    'Pwater_Renter_5km_BW');
save('Pwater_Renter_5km_HW.mat',...
    'Pwater_Renter_5km_HW');
