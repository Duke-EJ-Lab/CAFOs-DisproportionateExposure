...
Gwater_Renter_5km_BW = plots_BW;
Gwater_Renter_5km_HW = plots_HW;

save('Gwater_Renter_5km_BW.mat',...
    'Gwater_Renter_5km_BW');
save('Gwater_Renter_5km_HW.mat',...
    'Gwater_Renter_5km_HW');
