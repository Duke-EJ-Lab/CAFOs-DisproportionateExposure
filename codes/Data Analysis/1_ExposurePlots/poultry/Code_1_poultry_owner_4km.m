...
Poultry_Owner_4km_W = poultry_W;
Poultry_Owner_4km_B = poultry_B;
Poultry_Owner_4km_H = poultry_H;


save('Poultry_Owner_4km_W.mat',...
    'Poultry_Owner_4km_W');
save('Poultry_Owner_4km_B.mat',...
    'Poultry_Owner_4km_B');
save('Poultry_Owner_4km_H.mat',...
    'Poultry_Owner_4km_H');
%%
figure(1)
hold all
...
% saveas(gcf,'Poultry_CI_owner_4km.png')
