...
Poultry_Renter_4km_W = poultry_W;
Poultry_Renter_4km_B = poultry_B;
Poultry_Renter_4km_H = poultry_H;


save('Poultry_Renter_4km_W.mat',...
    'Poultry_Renter_4km_W');
save('Poultry_Renter_4km_B.mat',...
    'Poultry_Renter_4km_B');
save('Poultry_Renter_4km_H.mat',...
    'Poultry_Renter_4km_H');
...
title('Poultry Exposure, Renter, 4km','FontSize',10)
% saveas(gcf,'Poultry_CI_renter_4km.png')
