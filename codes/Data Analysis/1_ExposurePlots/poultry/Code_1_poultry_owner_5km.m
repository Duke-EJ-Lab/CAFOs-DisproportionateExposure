...
Poultry_Owner_5km_W = poultry_W;
Poultry_Owner_5km_B = poultry_B;
Poultry_Owner_5km_H = poultry_H;


save('Poultry_Owner_5km_W.mat',...
    'Poultry_Owner_5km_W');
save('Poultry_Owner_5km_B.mat',...
    'Poultry_Owner_5km_B');
save('Poultry_Owner_5km_H.mat',...
    'Poultry_Owner_5km_H');
%%
figure(1)
hold all
...
title('Poultry Exposure, Owner, 5km','FontSize',10)
% saveas(gcf,'Poultry_CI_owner_5km.png')
