...
Hogs_Owner_5km_W = hogs_W;
Hogs_Owner_5km_B = hogs_B;
Hogs_Owner_5km_H = hogs_H;


save('Hogs_Owner_5km_W.mat',...
    'Hogs_Owner_5km_W');
save('Hogs_Owner_5km_B.mat',...
    'Hogs_Owner_5km_B');
save('Hogs_Owner_5km_H.mat',...
    'Hogs_Owner_5km_H');
%%
figure(1)
hold all
...
title('Hogs Exposure, Owner','FontSize',10)
% saveas(gcf,'Hogs_CI_owner_5km.png')

%{
F4 = xline(35,'--','LineWidth',1.4,'color','k');
F5 = xline(100,'-.','LineWidth',1.4,'color','k');
hold off
legend([F1 F2 F3 F4 F5], ...
    'White','Black', 'Hispanic','LowToMid','MidToHigh', ...
    'Location','NE','Fontsize',10)
%}
