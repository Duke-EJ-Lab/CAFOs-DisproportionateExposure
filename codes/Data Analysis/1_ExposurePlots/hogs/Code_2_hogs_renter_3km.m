...
Hogs_Renter_3km_W = hogs_W;
Hogs_Renter_3km_B = hogs_B;
Hogs_Renter_3km_H = hogs_H;


save('Hogs_Renter_3km_W.mat',...
    'Hogs_Renter_3km_W');
save('Hogs_Renter_3km_B.mat',...
    'Hogs_Renter_3km_B');
save('Hogs_Renter_3km_H.mat',...
    'Hogs_Renter_3km_H');
...
title('Hogs Exposure, Renters','FontSize',10)
% saveas(gcf,'Hogs_CI_renter_3km.png')
