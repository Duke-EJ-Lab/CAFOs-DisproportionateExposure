...
Hogs_Renter_5km_W = hogs_W;
Hogs_Renter_5km_B = hogs_B;
Hogs_Renter_5km_H = hogs_H;


save('Hogs_Renter_5km_W.mat',...
    'Hogs_Renter_5km_W');
save('Hogs_Renter_5km_B.mat',...
    'Hogs_Renter_5km_B');
save('Hogs_Renter_5km_H.mat',...
    'Hogs_Renter_5km_H');
%%
figure(1)
hold all
...
% saveas(gcf,'Hogs_CI_renter_5km.png')
